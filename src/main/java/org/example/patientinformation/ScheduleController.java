...
public class ScheduleController {
    ...
    private void openDateTimeDialog() {
        ...
        dialog.showAndWait().ifPresent(result -> {
            ...
            BillingManager.addBillingRecord(appointment);
    ...
    private void loadAppointmentsFromFirestore() {
        ...
        try {
            ...
            for (QueryDocumentSnapshot doc : documents) {
                ...
                Appointment appointment = new Appointment(date, time, category);
                appointment.setFirestoreId(doc.getId());
                appointmentList.add(appointment);
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    private void deleteSelectedAppointment() {
        ...
        Firestore db = FirestoreClient.getFirestore();
        String userEmail = LoggedInUser.getEmail();
        String docId = selected.getFirestoreId();
